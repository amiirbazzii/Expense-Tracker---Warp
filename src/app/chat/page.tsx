...
function ChatPageContent() {
  ...
  return (
    <div className="flex flex-col h-screen bg-[#f8f8f8] pt-[64px] rtl:text-right ltr:text-left">
      <AppHeader title="Chat" />
      ...
      {!isOnline && (
        <div className="px-4 py-3 bg-orange-50 border-t border-orange-200 animate-slide-up">
      ...
      {error && (
        <div className={`px-4 py-3 border-t animate-slide-up ${
          error.code === 'NO_DATA' 
            ...
            <div className="flex items-start gap-2 flex-1">
              <svg 
                className={`w-5 h-5 flex-shrink-0 mt-0.5 ${
                  error.code === 'NO_DATA' ? 'text-yellow-600' : 'text-red-600'
                }`}
                fill="none" 
                stroke="currentColor" 
                viewBox="0 0 24 24"
