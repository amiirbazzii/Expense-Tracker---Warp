...
// The record id travels as ?id=… instead of a path segment. A `[id]` segment
// made this the only server-rendered route in the app — unreachable offline —
// even though every byte of its content comes from IndexedDB. As a static
// route it is precached by the app-shell warm-up and works with no network.
