...
describe("LocalStorageManager Implementation", () => {
  ...
  describe("Missing Entity Operations", () => {
    ...
    it("should update and delete for values", async () => {
      ...
      // Test update
      const updated = await manager.updateForValue("fv1", {
        value: "Updated Value",
      });
  ...
  describe("Data Validation", () => {
    ...
    it("should detect invalid expense entity", async () => {
      ...
      expect(result.errors.some((e) => e.includes("Invalid amount"))).toBe(
        true,
      );
    ...
    it("should repair corrupted entity", async () => {
      ...
      const repaired = (manager as any).attemptEntityRepair(
        corruptedEntity,
        "expenses",
      );
  ...
  describe("Storage Management", () => {
    ...
    it("should cleanup old data", async () => {
      ...
      const result = await manager.cleanupOldData({
  ...
  describe("Search and Utility", () => {
    ...
    it("should get total record count", async () => {
      mockStorage.getItem.mockImplementation((key: string) => {
        switch (key) {
          case "expenses":
            return Promise.resolve({ exp1: {}, exp2: {} });
          case "income":
            return Promise.resolve({ inc1: {} });
          case "categories":
